...
const Navbar = () => {
  ...
  return (
<nav className="sticky top-0 z-50 flex items-center justify-between px-6 mb-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white transition-all">
